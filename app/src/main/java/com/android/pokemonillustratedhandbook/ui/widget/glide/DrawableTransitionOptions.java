...
public final class DrawableTransitionOptions extends
    ...
    @NonNull
    public static DrawableTransitionOptions withCrossFade(int duration, boolean enableCrossFade) {
        return new DrawableTransitionOptions().crossFade(duration, enableCrossFade);
    }
    ...
    @NonNull
    public DrawableTransitionOptions crossFade(int duration, boolean enableCrossFade) {
        return crossFade(new DrawableCrossFadeFactory.Builder(duration).setCrossFadeEnabled(enableCrossFade));
    }
